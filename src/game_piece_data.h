...
#define GP_PAL_DOG      REL_PAL_PETS_SPECIAL_8x8FONT_OAM_3
#define GP_PAL_CAT      REL_PAL_PETS_SPECIAL_8x8FONT_OAM_3
#define GP_PAL_FISH     REL_PAL_PETS_SPECIAL_8x8FONT_OAM_3
#define GP_PAL_SNAKE    REL_PAL_PETS_SPECIAL_8x8FONT_OAM_3
//#define GP_PAL_EMPTY    0x00U // Use first pet palette -> Replaced with GP_ATTRIB_EMPTY
#define GP_ATTRIB_EMPTY 0x00u
#define GP_PAL_SPECIAL  REL_PAL_PETS_SPECIAL_8x8FONT_OAM_3
