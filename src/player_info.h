...
#define TEXT_HEIGHT_ROWS_8x16     2u
#define TEXT_GROUP_Y_SPACING      (TEXT_HEIGHT_ROWS_8x16 + 1u)


#define DISPLAY_LEVEL_X         1u
#define DISPLAY_LEVEL_Y_LABEL   1u
#define DISPLAY_LEVEL_Y         (DISPLAY_LEVEL_Y_LABEL + TEXT_HEIGHT_ROWS_8x16)
#define DISPLAY_LEVEL_READOUT_X (DISPLAY_LEVEL_X + 2u)

#define DISPLAY_DIFF_X          1u
#define DISPLAY_DIFF_Y          (DISPLAY_LEVEL_Y)

#define DISPLAY_SCORE_X         1u
...
#define DISPLAY_NEXT_PIECE_TEXT_Y       (DISPLAY_NEXT_PIECE_TEXT_Y_LABEL + TEXT_HEIGHT_ROWS_8x16)
...
#define DISPLAY_NUMPETS_X             1u
#define DISPLAY_NUMPETS_Y_LABEL_LINE1 (DISPLAY_NEXT_PIECE_TEXT_Y + (TEXT_GROUP_Y_SPACING - 1u)) // Less line spacing on this row
#define DISPLAY_NUMPETS_Y_LABEL_LINE2 (DISPLAY_NUMPETS_Y_LABEL_LINE1 + TEXT_HEIGHT_ROWS_8x16)
#define DISPLAY_NUMPETS_Y             (DISPLAY_NUMPETS_Y_LABEL_LINE2 + TEXT_HEIGHT_ROWS_8x16)
...
extern uint16_t player_numtiles;
extern uint16_t player_numpets;
