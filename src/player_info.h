...
#define GAME_PIECE_NEXT_PREVIEW_X ( (GAME_PIECE_NEXT_PREVIEW_BG_X + 1) * 8) + SPRITE_OFS_X
#define GAME_PIECE_NEXT_PREVIEW_Y ( (GAME_PIECE_NEXT_PREVIEW_BG_Y + 2) * 8) + SPRITE_OFS_Y
